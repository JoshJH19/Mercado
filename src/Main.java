                                        ...
                                        if (sc.hasNextInt()) {
                                            ...
                                            switch (opcion2) {
                                                ...
                                                case 5:
                                                    ...
                                                    System.out.println("La fecha es:" + factura.getFecha());
                                                    System.out.println("Nombre:" + factura.getNombre());
                                                    for (Productos p : listCarrito) {
                                                        System.out.println("Nombre del producto " + p.getNomProducto() + "=" + "Precio:" + p.getCantidad() + "*" + "Cantidad: " + p.getPrecio());
                                                    }
                                                    System.out.println("----------------------------------------------");

                                                    System.out.println("Total = $" +compras.getCalcularTotalPagar());
                                                    System.out.println("IVA = $" +compras.getCalcularTotalPagar() * 0.16);
                                                    System.out.println("----------------------------------------------");
